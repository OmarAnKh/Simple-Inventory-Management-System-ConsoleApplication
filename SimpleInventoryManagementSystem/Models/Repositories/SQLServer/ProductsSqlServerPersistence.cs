...
public class ProductsSqlServerPersistence(string connectionString) : IProductPersistence
{
    ...
    {
        const string query =
            "UPDATE Products SET Name = @NewName, Quantity = @Quantity, Price = @Price WHERE Name = @OldName";
